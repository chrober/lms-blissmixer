...
sub prefs {
    return ($prefs, 'host mixer_port', 'filter_genres', 'filter_xmas', 'min_duration', 'max_duration',
                    ...
                    'use_forest', 'use_adaptive_weights', 'num_seed_tracks', 'seed_strict_order', 'learned_blend', 'use_lastfm_weighting', 'lastfm_weighting_weight', 'lastfm_cooldown', 'analyser_ignore_dirs', 'analyser_max_files', 'analyser_max_threads',
